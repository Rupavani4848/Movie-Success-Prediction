...
def runELM():
    ...
    recall.append(r)
    fscore.append(f)
    text.insert(END,"Simple Deep Learning Accuracy  :  "+str(a)+"\n")
    text.insert(END,"Simple Deep Precision : "+str(p)+"\n")
    text.insert(END,"Simple Deep Recall    : "+str(r)+"\n")
    text.insert(END,"Simple Deep FScore    : "+str(f)+"\n\n")
    
    calculateMetrics("Simple Deep Learning Machine", predict, y_test)    
...
def graph():
    ...
    output+="<tr><td>Deep Learning Algorithm</td><td>"+str(accuracy[3])+"</td><td>"+str(precision[3])+"</td><td>"+str(recall[3])+"</td><td>"+str(fscore[3])+"</td></tr>"
...
elmButton = Button(main, text="Simple Deep Learning Model", command=runELM)
